...
function slider() {
    ...
    if (slides.length < 10) {
        ...
        curr.textContent = `0${currIndex}`;
    } else {
        total.textContent = slides.length;
        curr.textContent = currIndex;
    }
...
window.addEventListener('DOMContentLoaded', () => {
   ...
   const calc = __webpack_require__(/*! ./modules/calculator */ "./src/js/modules/calculator.js"),
